...
train_data = MRIDataset(annotations_file=TRAIN_SET, img_dir=RAW_DATA, transform=train_transform)
test_data = MRIDataset(annotations_file=TEST_SET, img_dir=RAW_DATA, transform=test_transform)
